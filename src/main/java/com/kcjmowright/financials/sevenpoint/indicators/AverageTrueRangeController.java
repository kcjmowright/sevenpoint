...
@RestController
@RequestMapping("/average-true-range")
@RequiredArgsConstructor
public class AverageTrueRangeController {
  ...
  public List<AverageIndicatorValue> getAverageTrueRange(@PathVariable(name = "symbol") String symbol, @DateTimeFormat(iso =
    ...
    return new AverageTrueRange(quoteService.getQuotesBySymbolAndDateRange(symbol, start, end), isNull(period) ? 20 : period).getValues();
  }
}
