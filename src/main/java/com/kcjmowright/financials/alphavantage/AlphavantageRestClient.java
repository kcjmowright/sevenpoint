...
public class AlphavantageRestClient {
    ...
    public Map<String, Map<String, Map>> getTimeSeriesDaily(String symbol, String apiKey, OutputSize outputSize, DataType dataType) {
        ...
        return client.get()
            .uri("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol={symbol}&apikey={apiKey}&outputsize={outputSize}&datatype={dataType}", 
                symbol, apiKey, os.getLabel(), dt.getLabel())
            .retrieve()
            .body(HashMap.class);
    }
    ...
    public Map<String, String> getCompanyOverview(String symbol, String apiKey) {
        return client.get()
            .uri("https://www.alphavantage.co/query?function=OVERVIEW&symbol={symbol}&apikey={apiKey}", 
                symbol, apiKey)
            .retrieve()
            .body(HashMap.class);
    }
